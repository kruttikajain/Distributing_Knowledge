...
r = redis.Redis(host="localhost", port="8103")
#random.seed(444)
...
class library(SyncObj):
    def __init__(self):
        super().__init__('localhost:4324', ['localhost:4321','localhost:4322','localhost:4323'])
    ...
    def loanitem(self, itemid: int, studentid: int) -> None:
        with open('log4.txt', 'a') as logfile:
