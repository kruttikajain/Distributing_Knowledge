...
r = redis.Redis(host="localhost", port="8102")
#random.seed(444)
...
class library(SyncObj):
    def __init__(self):
        super().__init__('localhost:4323', ['localhost:4321','localhost:4322', 'localhost:4324'])
    ...
    def loanitem(self, itemid: int, studentid: int) -> None:
        with open('log3.txt', 'a') as logfile:
