...
r = redis.Redis(host="localhost", port="8100")
#random.seed(444)
...
class library(SyncObj):
    def __init__(self):
        super().__init__('localhost:4321', ['localhost:4322','localhost:4323','localhost:4322'])
...
if __name__ == '__main__':
    ...
    obj.init_db()
    sleep(5)
    obj.loanitem("b001", "s004")
    sleep(0.6)
    obj.loanitem("b020", "s020")
    sleep(0.6)
